...
export default function CrearEvento() {
  ...
  const handleSubmit = (e) => {
    ...
    // VALIDACIONES -----------------------------
    if (!form.nombre.trim()) {
      alert("Ingresá un nombre para el evento.");
      return;
    }
    if (!form.fechaHora) {
    ...
    if (!form.venueId) {
      alert("Seleccioná un venue.");
      return;
    }

    // FIX FECHA — convertir a ISO antes de enviar
    const payload = {
      ...form,
  ...
  return (
    <div className="ce2-page">
      ...
      <form onSubmit={handleSubmit} className="ce2-card">
        ...
        <button type="submit" className="ce2-btn">
          Crear evento
        </button>
      </form>
    </div>
